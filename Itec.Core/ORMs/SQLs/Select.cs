...
//namespace Itec.Entities.DBs.SQLs
//{
//    public class Select
//    {
//        public Select(EntityClass model, string fieldnames)
//        {
//            this.Model = model;
...
//        public EntityClass Model { get; private set; }
...
//        public int Execute(Expression expr, DbConnection conn, DbTransaction trans,Action<object> readed=null)
//        {
...
//        public async Task<int> ExecuteAsync(Expression expr, DbConnection conn, DbTransaction trans, Action<object> readed = null)
//        {
//            var cmd = BuildCommand(expr, conn, trans);
//            int i = 0;
